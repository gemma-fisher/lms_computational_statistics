...
p_6_scipy <- dunif(x, min = a - 0.5, max = b + 0.5)
...
p_3_scipy <- dunif(x, min = a - 0.5, max = b + 0.5)
...
cat("\nProbability of observing", x, "or less cancer patients with average", lambda, ":", p_manual, "\n")
cat("Probability of observing", x, "or less cancer patients with average", lambda, ":", p_scipy, "\n")

# Probability of more than 5 patients, with same average
x <- 5; lambda <- 5
p_manual <- 1 - p_manual
p_scipy <- 1 - p_scipy
cat("\nProbability of observing more than", x, "cancer patients with average", lambda, ":", p_manual, "\n")
cat("Probability of observing more than", x, "cancer patients with average", lambda, ":", p_scipy, "\n")
